...
class Libvirt 
{
    ...
    function domain_new($name, $arch, $memMB, $maxmemMB, $vcpus, $iso_image, $disks, $networks, $flags)
    {
        return libvirt_domain_new($this->conn, $name, $arch, $memMB, $maxmemMB, $vcpus, $iso_image, $disks, $networks, $flags);
    }
